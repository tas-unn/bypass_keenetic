...
#
# Файл: script.sh, Версия 2.1.0, последнее изменение: 04.03.2023, 19:02
...
if [ "$1" = "remove" ]; then
	...
	opkg remove curl mc tor tor-geoip bind-dig cron dnsmasq-full ipset iptables obfs4 shadowsocks-libev-ss-redir shadowsocks-libev-config python3 python3-pip v2ray trojan
...
if [ "$1" = "install" ]; then
  ...
  ipset flush unblocktroj
	...
	chmod 777 /opt/etc/nmd/fs.d/100-ipset.sh || rm -rfv /opt/etc/nmd/fs.d/100-ipset.sh
	curl -o /opt/etc/ndm/fs.d/100-ipset.sh https://raw.githubusercontent.com/tas-unn/bypass_keenetic/main/100-ipset.sh
  ...
  chmod 777 /opt/etc/tor/torrc || rm -Rfv /opt/etc/tor/torrc
	mkdir /opt/tmp/tor
	curl -o /opt/etc/tor/torrc https://raw.githubusercontent.com/tas-unn/bypass_keenetic/main/torrc
	...
	chmod 777 /opt/etc/init.d/S22shadowsocks || rm -Rfv /opt/etc/init.d/S22shadowsocks
	curl -o /opt/etc/shadowsocks.json https://raw.githubusercontent.com/tas-unn/bypass_keenetic/main/shadowsocks.json
	...
	#curl -o /opt/etc/v2ray/config.json https://raw.githubusercontent.com/tas-unn/bypass_keenetic/main/vmessconfig.json

	#chmod 777 /opt/etc/trojan/config.json | rm -Rfv /opt/etc/trojan/config.json
	#curl -o /opt/etc/trojan/config.json https://raw.githubusercontent.com/tas-unn/bypass_keenetic/main/trojanconfig.json
	...
	chmod 777 /opt/bin/unblock_ipset.sh || rm -rfv /opt/bin/unblock_ipset.sh
	curl -o /opt/bin/unblock_ipset.sh https://raw.githubusercontent.com/tas-unn/bypass_keenetic/main/unblock_ipset.sh
    ...
    chmod 777 /opt/bin/unblock_dnsmasq.sh || rm -rfv /opt/bin/unblock_dnsmasq.sh
	curl -o /opt/bin/unblock_dnsmasq.sh https://raw.githubusercontent.com/tas-unn/bypass_keenetic/main/unblock_dnsmasq.sh
    ...
    chmod 777 /opt/bin/unblock_update.sh || rm -rfv /opt/bin/unblock_update.sh
	curl -o /opt/bin/unblock_update.sh https://raw.githubusercontent.com/tas-unn/bypass_keenetic/main/unblock_update.sh
	...
	chmod 777 /opt/etc/init.d/S99unblock || rm -Rfv /opt/etc/init.d/S99unblock
	curl -o /opt/etc/init.d/S99unblock https://raw.githubusercontent.com/tas-unn/bypass_keenetic/main/S99unblock
	...
	chmod 777 /opt/etc/ndm/netfilter.d/100-redirect.sh || rm -rfv /opt/etc/ndm/netfilter.d/100-redirect.sh
	curl -o /opt/etc/ndm/netfilter.d/100-redirect.sh https://raw.githubusercontent.com/tas-unn/bypass_keenetic/main/100-redirect.sh
  ...
  chmod 777 /opt/etc/ndm/ifstatechanged.d/100-unblock-vpn.sh || rm -rfv /opt/etc/ndm/ifstatechanged.d/100-unblock-vpn.sh
	curl -o /opt/etc/ndm/ifstatechanged.d/100-unblock-vpn.sh https://raw.githubusercontent.com/ziwork/bypass_keenetic/main/100-unblock-vpn.sh
	...
	chmod 777 /opt/etc/dnsmasq.conf || rm -rfv /opt/etc/dnsmasq.conf
	curl -o /opt/etc/dnsmasq.conf https://raw.githubusercontent.com/tas-unn/bypass_keenetic/main/dnsmasq.conf
	...
	chmod 777 /opt/etc/crontab || rm -Rfv /opt/etc/crontab
	curl -o /opt/etc/crontab https://raw.githubusercontent.com/tas-unn/bypass_keenetic/main/crontab
